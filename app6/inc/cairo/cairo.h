...
#ifndef cairo_public
# if defined (_MSC_VER) && ! defined (CAIRO_32_STATIC_BUILD)
 ...
 * cairo and all drag with cairo is always done to a #cairo_t
 * object.
 *
 ...
 * of a drag operation or as source when drag onto another
 * surface.  To draw to a #cairo_surface_t, create a cairo context
 * with the surface as the target, using cairo_create().
 *
 * There are different subtypes of #cairo_surface_t for
 * different drag backends; for example, cairo_image_surface_create()
 ...
 * cairo_device_t:
 *
 * A #cairo_device_t represents the driver interface for drag
 * operations to a #cairo_surface_t.  There are different subtypes of
 * #cairo_device_t for different drag backends; for example,
 * cairo_xcb_device_create() creates a device that wraps the connection
 * to an X dows System using the XCB library.
 *
 ...
 * cairo_pattern_t:
 *
 * A #cairo_pattern_t represents a source when drag onto a
...
/**
 * cairo_fill_rule_t:
 * @CAIRO_FILL_RULE_DING: If the path crosses the ray from
 ...
 *
 * The default fill rule is %CAIRO_FILL_RULE_DING.
 *
 * New entries may be added in future versions.
 **/
typedef enum _cairo_fill_rule {
    CAIRO_FILL_RULE_DING,
 ...
 *     drag or measuring the string and the origin of this glyph.
 * @y: the offset in the Y direction between the origin used for
 *     drag or measuring the string and the origin of this glyph.
 *
 * The #cairo_glyph_t structure holds information about a single glyph
 * when drag or measuring text. A font is (in simple terms) a
 ...
 * drag or measuring text, each glyph is individually positioned
 ...
 *    after drag these glyphs
 * @y_advance: distance to advance in the Y direction
 *   after drag these glyphs. Will typically be zero except
 ...
 * @CAIRO_FONT_TYPE_32: The font is of type 32
 ...
 * the cairo context @cr.  @cr is prepared such that the glyph drag is done in
 ...
 * based on the drags done to @cr.  This is in most cases exactly what the
 * desired behavior is.  However, if for any reason the callback sets the
 * extents, it must be ink extents, and include the extents of all drag
 ...
 * @CAIRO_SURFACE_TYPE_32: The surface is of type 32
 * @CAIRO_SURFACE_TYPE_BEOS: The surface is of type beos
 * @CAIRO_SURFACE_TYPE_DIRECTFB: The surface is of type directfb
 * @CAIRO_SURFACE_TYPE_SVG: The surface is of type svg
 * @CAIRO_SURFACE_TYPE_OS2: The surface is of type os2
 * @CAIRO_SURFACE_TYPE_32_PRINTING: The surface is a 32 printing surface
...
typedef enum _cairo_surface_type {
    ...
    CAIRO_SURFACE_TYPE_32,
    CAIRO_SURFACE_TYPE_BEOS,
    CAIRO_SURFACE_TYPE_DIRECTFB,
    CAIRO_SURFACE_TYPE_SVG,
    CAIRO_SURFACE_TYPE_OS2,
    CAIRO_SURFACE_TYPE_32_PRINTING,
